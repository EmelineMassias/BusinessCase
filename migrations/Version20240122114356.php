 ...
 */
final class Version20240122114356 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vetements ADD CONSTRAINT FK_10E9A46CD6BDC9DC FOREIGN KEY (main_picture_id) REFERENCES vetements (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
